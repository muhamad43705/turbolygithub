...
include  $_SERVER ['DOCUMENT_ROOT'] . '/_include.php';    
...
$baseUrl = $class->defaultURLUploadPath .'uploadeditor/';

$class->setLog('$baseUrl ' . $baseUrl);
...
$baseDir = $class->defaultDocUploadPath .'uploadeditor/'; 

if (!is_dir($baseDir)) 
        mkdir($baseDir, 0775, true);

$class->setLog('$baseDir ' , $baseDir);
