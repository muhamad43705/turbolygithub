...
class CKFinder_Connector_Utils_FileSystem
{
  ...
  'Û' => 'U', 'Þ' => 'Th', 'Ð' => 'Dh', 'Æ' => 'Ae', 'Ĕ' => 'E',
    ...
    public function getDocumentRootPath()
    {
         ...
         * $_SERVER['SCRIPT_FILE_NAME'] will contain the relative path specified by the user.
         */
        if (isset($_SERVER['SCRIPT_FILE_NAME'])) {
            $sRealPath = dirname($_SERVER['SCRIPT_FILE_NAME']);
        }
        else {
            /**
